...
// Setters
void BMSData::addDataItem( std::string name, 
...
// Getters
std::unordered_map<std::string, std::unordered_map<double,double>> BMSData::getAllTimeSeriesData() {
    return allTimeSeriesData; 
}

int BMSData::getByteSize() { 
    return byteSize;
}


// Utility
void BMSData::printAllTimeSeriesData(){
...
BMSData BMSData::difference(BMSData& other) const{
